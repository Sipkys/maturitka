...
?>
<form method="post">
<input type="number" name="<?php echo $bookean ?>">EAN</br>
<input type="text" name="<?php echo $booktitle ?>">Title</br>
<input type="number" name="<?php echo $bookpages ?>">Počet stran</br>
<input type="text" name="<?php echo $bookdes ?>">Popisek</br>
<input type="number" name="<?php echo $bookg ?>">Žánr</br>
<input type="number" name="<?php echo $bookl ?>">Půjčeno</br>
